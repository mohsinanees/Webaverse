...
describe("Claim", async function () {
    ...
    context("With valid signature, valid nonce, valid expiry", async function () {
        it("Should redeem an NFT from a signed voucher", async function () {
            ...
            const voucher = await lazyMinter.createVoucher(validTokenIds[0], nonce, expiry + 100);
    ...
    context("With invalid signature, invalid nonce, invalid expiry", async function () {
        ...
        it("Should fail to redeem an NFT with already used nonce", async function () {
            ...
            let lazyMinter = new LazyMinter({
                contract: claimerContract,
                signer: signer,
            });
            let voucher = await lazyMinter.createVoucher(validTokenIds[0], nonce, expiry + 100);
            ...
            voucher = await lazyMinter.createVoucher(validTokenIds[0], nonce, expiry + 100);
