...
contract GhoulieNFT is ERC721URIStorage, EIP712, AccessControl, Ownable {
        ...
        EIP712(SIGNING_DOMAIN, SIGNATURE_VERSION)
    {
        ...
        ownerMint(
            7479,
            "bafkreiadwwbgtd7gbpplrrcqyshmzandmblzgkqtmhi3sxfqekubeh7mke"
        );
        ownerMint(
            9811,
            "bafkreicpia2v34ptrieu7knevhoybbyfpeqyfz4lywjwtzfdvfghzrtjlm"
        );
        ownerMint(
            10001,
            "bafkreigbtxhlpz2pqjvfwfw6sdx44czrsw25kqqgj7ikzoxlqi5gz6lpva"
        );
    }
    ...
    function mint(address account, string memory cid) public onlyOwner {
        ...
        if (presaleStatus()) {
            require(
                balance < 2,
                "Redeemer has reached the redemption limit for presale"
            );
        } else {
            require(balance < 3, "Redeemer has reached the redemption limit");
        }
